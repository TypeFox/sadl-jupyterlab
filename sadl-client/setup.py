...
extension_root = os.path.join(here, 'sadl_web')
...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'sadl_web', 'build', 'bundle.js'),
    ]
...
setup_args = {
    ...
    'description': 'A prototype for SADL in a web browser.',
    ...
    'entry_points': {
        'console_scripts': [
            'sadl_web = sadl_web.sadlapp:main',
        ]
    },
    'author': 'TypeFox',
    'author_email': 'info@typefox.io',
    'url': 'http://typefox.io',
    'keywords': ['sadl', 'semanticweb', 'owl'],
    'classifiers': [
